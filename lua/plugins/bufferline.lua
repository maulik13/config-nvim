...
local function getHighlights()
  ...
  return {
    ...
    separator_selected = { fg = inactive_bg, bg = active_bg, sp = active_sp },
    ...
    diagnostic_selected = { fg = C.subtext0, bg = active_bg, style = styles, sp = active_sp },
    -- Modified
  ...
  --       -- separators
  --       separator = { fg = inactive_bg, bg = active_bg },
  --       separator_visible = { fg = inactive_bg, bg = inactive_bg },
  --       separator_selected = { fg = inactive_bg, bg = active_bg },
  --       offset_separator = { fg = C.crust, bg = inactive_bg },
  --       -- close buttons
  --       close_button = { fg = C.surface1, bg = inactive_bg },
  --       close_button_visible = { fg = C.surface1, bg = inactive_bg },
